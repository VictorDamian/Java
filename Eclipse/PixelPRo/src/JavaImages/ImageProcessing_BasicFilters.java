...
public class ImageProcessing_BasicFilters {
     ...
     */
    public enum filtersAvailable{rojo,verde,azul, inve}
    /**
     ...
     */
    public enum invertColorsAvailable{RGB,rojo,verde,azul}
    ...
    private BufferedImage selectFilter(BufferedImage image,filtersAvailable colorFilter){
        ...
        super.updateImage("Transformación de la imagen: " + "filtro "+ colorFilter.toString(), imageTemp);
        return imageTemp;
    }
    ...
    private BufferedImage RGB_to(BufferedImage image,RGBTransformAvailable chanel){
        ...
        super.updateImage("Transformación de la imagen: RGB a " + chanel.toString(), imageTemp);
        return imageTemp;
    }
    ...
    private BufferedImage invertColors(BufferedImage image, invertColorsAvailable chanelInvert){
        ...
        super.updateImage("Transformación de la imagen: colores invertidos (" + chanelInvert + ")", imageTemp);
        return imageTemp;
    }
    ...
    public BufferedImage grayScale(BufferedImage image){
        ...
        super.updateImage("Transformación de la imagen: escala de grises", imageTemp);
        return imageTemp;
    }
    ...
    public BufferedImage blackAndWhite(BufferedImage image,int threshold){
        ...
        super.updateImage("Transformación de la imagen: Blanco y negro. Brillo: " + threshold, imageTemp);
        return imageTemp;
    }
